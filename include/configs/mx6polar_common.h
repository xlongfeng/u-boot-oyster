...
#ifndef __MX6POLAR_COMMON_CONFIG_H
#define __MX6POLAR_COMMON_CONFIG_H
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"findfdt="\
		"if test $fdt_file = undefined; then " \
			"if test $board_name = POLAR && test $board_rev = MX6DL; then " \
				"setenv fdt_file imx6dl-polar-ldo.dtb; fi; " \
			"if test $fdt_file = undefined; then " \
...
#endif                         /* __MX6POLAR_COMMON_CONFIG_H */
